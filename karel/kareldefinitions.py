...
COLOR_OPTIONS = sorted(
    ["Red", "Black", "Cyan", "Dark Gray", "Gray", "Green", "Light Gray", "Magenta", "Orange", "Pink", "White", "Blue",
     "Yellow"])
COLOR_MAP = {"Red": "red", "Black": "black", "Cyan": "cyan", "Dark Gray": "gray30", "Gray": "gray55", "Green": "green",
             "Light Gray": "gray80", "Magenta": "magenta3", "Orange": "orange", "Pink": "pink", "White": "snow",
...
class Wall():
    ...
    def __eq__(self, other):
        return self._avenue == other.avenue and self._street == other.street and self._direction == other.direction
...
NEXT_DIRECTION_MAP = {Direction.NORTH: Direction.WEST, Direction.WEST: Direction.SOUTH, Direction.SOUTH: Direction.EAST,
...
DIRECTION_DELTA_MAP = {Direction.NORTH: (0, 1), Direction.EAST: (1, 0), Direction.SOUTH: (0, -1),
    Direction.WEST: (-1, 0)}
