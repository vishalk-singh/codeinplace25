...
class KarelApplication(tk.Frame):
    def __init__(self, karel, world, code_file, master=None, window_width=800, window_height=600, canvas_width=600,
                 canvas_height=400):
    ...
    def create_menubar(self):
        ...
        fileMenu.add_command(label="Exit", underline=1, command=self.master.quit, accelerator="Cmd+W")
    ...
    def create_slider(self):
        ...
        self.fast_label = tk.Label(self.slider_frame, text="Fast", bg=LIGHT_GREY, fg=BLACK)
        self.fast_label.pack(side="right")

        self.slow_label = tk.Label(self.slider_frame, text="Slow", bg=LIGHT_GREY, fg=BLACK)
        self.slow_label.pack(side="left")

        self.speed = tk.IntVar()

        self.scale = tk.Scale(self.slider_frame, orient=tk.HORIZONTAL, variable=self.speed, showvalue=False,
                              bg=LIGHT_GREY, fg=WHITE, highlightthickness=0, highlightbackground=WHITE)
    ...
    def create_buttons(self):
        ...
        self.load_world_button = tk.Button(self, highlightthickness=0, text="Load World",
                                           highlightbackground=LIGHT_GREY, command=self.load_world)
    ...
    def create_status_label(self):
        ...
        """
        self.status_label = tk.Label(self.master, text="Welcome to Karel!", bg=LIGHT_GREY, fg=BLACK)
