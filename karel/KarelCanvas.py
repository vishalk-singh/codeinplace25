...
class KarelCanvas(tk.Canvas):
    def __init__(self, width, height, master, world=None, karel=None, bg="white"):
        super().__init__(master, width=width, height=height, bg=bg, highlightbackground=WHITE)
        self.world = world
        self.karel = karel
    ...
    def draw_bounding_rectangle(self):
        ...
        self.create_line(self.left_x, self.top_y, self.right_x, self.top_y, width=LINE_WIDTH, fill=BLACK)
        self.create_line(self.left_x, self.top_y, self.left_x, self.bottom_y, width=LINE_WIDTH, fill=BLACK)
        self.create_line(self.right_x, self.top_y, self.right_x, self.bottom_y, width=LINE_WIDTH, fill=BLACK)
        self.create_line(self.left_x, self.bottom_y, self.right_x, self.bottom_y, width=LINE_WIDTH, fill=BLACK)
    ...
    def label_axes(self):
        ...
        for avenue in range(1, self.world.num_avenues + 1):
            ...
            self.create_text(label_x, label_y, text=str(avenue), font="Arial 10", fill=BLACK)
        ...
        for street in range(1, self.world.num_streets + 1):
            ...
            self.create_text(label_x, label_y, text=str(street), font="Arial 10", fill=BLACK)
            ...
            for street in range(1, self.world.num_streets + 1):
                ...
                if not color:
                    ...
                    self.create_rectangle(corner_x - self.cell_size / 2, corner_y - self.cell_size / 2,
                                          corner_x + self.cell_size / 2, corner_y + self.cell_size / 2, fill=color,
                                          tag="corner", outline="")
    ...
    def draw_beeper(self, location, count):
        ...
        if count > 1:
            self.create_text(corner_x, corner_y, text=str(count), font="Arial 12", tag="beeper", fill=BLACK)
    ...
    def draw_wall(self, wall):
        ...
        if direction == Direction.NORTH:
            self.create_line(corner_x - self.cell_size / 2, corner_y - self.cell_size / 2,
                             corner_x + self.cell_size / 2, corner_y - self.cell_size / 2, width=LINE_WIDTH, tag="wall",
                             fill="black")
