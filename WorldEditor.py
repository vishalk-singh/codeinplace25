...
class WorldBuilderApplication(tk.Frame):
    ...
    def create_new_world(self, init=False, default=False):
        num_avenues = simpledialog.askinteger("New World Size", "How many avenues should the new world have?",
                                              parent=self.master, minvalue=MIN_DIMENSIONS, maxvalue=MAX_DIMENSIONS)
    ...
    def create_buttons(self):
        ...
        """
        self.program_control_button = tk.Button(self, highlightthickness=0, highlightbackground=LIGHT_GREY)
        ...
        self.load_world_button = tk.Button(self, highlightthickness=0, highlightbackground=LIGHT_GREY,
                                           text="Load World", command=self.load_world)
        self.load_world_button.grid(column=0, row=1, padx=PAD_X, pady=PAD_Y)

        self.save_world_button = tk.Button(self, highlightthickness=0, highlightbackground=LIGHT_GREY,
                                           text="Save World", command=self.save_world)
    ...
    def create_direction_radio_buttons(self):
        ...
        dir_label = tk.Label(self.dir_radio_frame, text="Karel Direction: ", bg=LIGHT_GREY, fg=BLACK)
        dir_label.pack(side="left")
        tk.Radiobutton(self.dir_radio_frame, text="E", variable=self.karel_direction_var, value="east", bg=LIGHT_GREY,
                       fg=BLACK).pack(side="left")
        tk.Radiobutton(self.dir_radio_frame, text="W", variable=self.karel_direction_var, value="west", bg=LIGHT_GREY,
                       fg=BLACK).pack(side="left")
        tk.Radiobutton(self.dir_radio_frame, text="N", variable=self.karel_direction_var, value="north", bg=LIGHT_GREY,
                       fg=BLACK).pack(side="left")
        tk.Radiobutton(self.dir_radio_frame, text="S", variable=self.karel_direction_var, value="south", bg=LIGHT_GREY,
                       fg=BLACK).pack(side="left")
    ...
    def create_beeper_bag_radio_buttons(self):
        ...
        beeper_bag_label = tk.Label(self.beeper_bag_radio_frame, text="Beeper Bag: ", bg=LIGHT_GREY, fg=BLACK)
        beeper_bag_label.pack(side="left")
        tk.Radiobutton(self.beeper_bag_radio_frame, text="Empty", variable=self.beeper_bag_var, value=0, bg=LIGHT_GREY,
                       fg=BLACK).pack(side="left")
        tk.Radiobutton(self.beeper_bag_radio_frame, text="INFINITY", variable=self.beeper_bag_var, value=INFINITY,
                       bg=LIGHT_GREY, fg=BLACK).pack(side="left")
    ...
    def create_action_radio_buttons(self):
        ...
        action_label = tk.Label(self.action_radio_frame, text="Action: ", bg=LIGHT_GREY, fg=BLACK)
        ...
        tk.Radiobutton(self.action_radio_frame, text="Move Karel", variable=self.action_var, value="move_karel",
                       bg=LIGHT_GREY, fg=BLACK).pack(anchor='w')
        ...
        self.color_dropdown["fg"] = BLACK
        self.color_dropdown["activeforeground"] = BLACK
